...
public class FunctionalValidatorTests {
	...
	public static Collection<Object[]> data() {
		Object[][] data = new Object[][] {
				...
				{
						"Testcases/rules/SA00003/ExitOnStandardFaultButCatchingStandardFaultInDirectFaultHandlers.bpel",
						"3" },
				{
						"Testcases/rules/SA00003/ExitOnStandardFaultButCatchingStandardFaultInDirectFaultHandlersInProcess.bpel",
						"3" },
				{
						"Testcases/rules/SA00003/ExitOnStandardFaultButCatchingStandardFaultInIndirectFaultHandlers.bpel",
						"3" },
				{
						"Testcases/rules/SA00003/ExitOnStandardFaultButCatchingStandardFaultInIndirectNestedFaultHandlers.bpel",
						"3" },
				{
						"Testcases/rules/SA00003/ExitOnStandardFaultButCatchingStandardFaultInNestedFaultHandlers.bpel",
						"3" },

				{ "Testcases/rules/SA00005/InvokeWithNonExistentPortType.bpel",
						"5, 10" },
				{
						"Testcases/rules/SA00005/OnEventWithNonExistentPortType.bpel",
						"5, 10" },
				{
						"Testcases/rules/SA00005/OnMessageWithNonExistentPortType.bpel",
						"5, 10" },
				{
						"Testcases/rules/SA00005/ReceiveWithNonExistentPortType.bpel",
						"5, 10" },
				{ "Testcases/rules/SA00005/ReplyWithNonExistentPortType.bpel",
						"5, 10" },

				{ "Testcases/rules/SA00006/RethrowOutsideFaultHandlers.bpel",
						"6" },

				{
						"Testcases/rules/SA00007/CompensateScopeOutsideFaultHandlers.bpel",
						"7" },

				{
						"Testcases/rules/SA00008/CompensateOutsideFaultHandlers.bpel",
						"8" },

				{
						"Testcases/rules/SA00010/UndefinedType-Catch-FaultElement.bpel",
						"10" },
				{
						"Testcases/rules/SA00010/UndefinedType-Catch-FaultMessageType.bpel",
						"10" },
				{ "Testcases/rules/SA00010/UndefinedType-CorrelationSet.bpel",
						"10, 21" },
				...
				{ "Testcases/rules/SA00010/UndefinedType-OnMessage.bpel",
						"10, 5" },
				{ "Testcases/rules/SA00010/UndefinedType-PartnerLink.bpel",
						"10" },
				...
				{
						"Testcases/rules/SA00010/UndefinedType-Variable-Element.bpel",
						"10" },
				{
						"Testcases/rules/SA00010/UndefinedType-Variable-MessageType.bpel",
						"10" },
				{ "Testcases/rules/SA00010/UndefinedType-Variable-Type.bpel",
						"10" },
				...
				{
						"Testcases/rules/SA00015/NoActivityWithCreateInstanceSetToYes.bpel",
						"15" },
				{
						"Testcases/rules/SA00015/OnlyActivityWithCreateInstanceSetToNo.bpel",
						"15" },

				{
						"Testcases/rules/SA00016/PartnerLinkWithoutMyRoleAndPartnerRole.bpel",
						"16" },

				{
						"Testcases/rules/SA00017/InitializePartnerRoleUsedOnPartnerLinkWithoutPartnerRole.bpel",
						"17" },

				{ "Testcases/rules/SA00018/TwoPartnerLinksWithSameName.bpel",
						"18" },

				{ "Testcases/rules/SA00019/PropertyWithoutTypeOrElement.bpel",
						"19" },
				{ "Testcases/rules/SA00019/PropertyWithTypeAndElement.bpel",
						"19" },

				{
						"Testcases/rules/SA00020/PropertyAlias-AllOptionalAttributes.bpel",
						"20" },
				{
						"Testcases/rules/SA00020/PropertyAlias-MessageTypeAttribute.bpel",
						"20" },
				{
						"Testcases/rules/SA00020/PropertyAlias-MessageTypeElementAttributes.bpel",
						"20" },
				{
						"Testcases/rules/SA00020/PropertyAlias-MessageTypePartElementAttributes.bpel",
						"20" },
				{
						"Testcases/rules/SA00020/PropertyAlias-MessageTypePartTypeAttributes.bpel",
						"20" },
				{
						"Testcases/rules/SA00020/PropertyAlias-MessageTypeTypeAttributes.bpel",
						"20" },
				{
						"Testcases/rules/SA00020/PropertyAlias-MessageTypeTypeElementAttributes.bpel",
						"20" },
				{
						"Testcases/rules/SA00020/PropertyAlias-NoOptionalAttributes.bpel",
						"20" },
				{ "Testcases/rules/SA00020/PropertyAlias-PartAttribute.bpel",
						"20" },
				{
						"Testcases/rules/SA00020/PropertyAlias-PartElementAttributes.bpel",
						"20" },
				{
						"Testcases/rules/SA00020/PropertyAlias-PartTypeAttributes.bpel",
						"20" },
				{
						"Testcases/rules/SA00020/PropertyAlias-PartTypeElementAttributes.bpel",
						"20" },
				{
						"Testcases/rules/SA00020/PropertyAlias-TypeElementAttributes.bpel",
						"20" },

				{
						"Testcases/rules/SA00021/CorrelationSet-Properties-Undefined.bpel",
						"21, 10" },
				{ "Testcases/rules/SA00021/From-Property-Undefined.bpel",
						"21, 10" },
				{ "Testcases/rules/SA00021/OnEvent-Variable-Undefined.bpel",
						"21" },
				{ "Testcases/rules/SA00021/To-Property-Undefined.bpel",
						"21, 10" },

				{
						"Testcases/rules/SA00022/Duplicate-propertyAliasElement.bpel",
						"22" },
				{
						"Testcases/rules/SA00022/Duplicate-propertyAliasMessageType.bpel",
						"22" },
				{ "Testcases/rules/SA00022/Duplicate-propertyAliasType.bpel",
						"22" },

				{ "Testcases/rules/SA00023/Process-Duplicated-Variables.bpel",
						"23" },
				{ "Testcases/rules/SA00023/Scope-Duplicated-Variables.bpel",
						"23" },
				{
						"Testcases/rules/SA00023/Scope-Scope-Duplicated-Variables.bpel",
						"23" },
				...
				{
						"Testcases/rules/SA00025/Variable-havingMessageTypeAndElement.bpel",
						"25" },
				{ "Testcases/rules/SA00025/Variable-havingTypeAndElement.bpel",
						"25" },
				{
						"Testcases/rules/SA00025/Variable-havingTypeAndMessageType.bpel",
						"25" },
				{
						"Testcases/rules/SA00025/Variable-havingTypeAndMessageTypeAndElement.bpel",
						"25" },
				{
						"Testcases/rules/SA00025/Variable-missingMessageTypeAndTypeAndElement.bpel",
						"25" },

				{
						"Testcases/rules/SA00044/Process-CorrelationSet-Ambiguous.bpel",
						"44" },
				{
						"Testcases/rules/SA00044/Scope-CorrelationSets-Ambiguous.bpel",
						"44" },
				...
				{
						"Testcases/rules/SA00046/Invoke-OneWay-Correlation-Pattern.bpel",
						"46" },
				{
						"Testcases/rules/SA00046/Invoke-RequestResponse-Correlation-PatternMissing.bpel",
						"46" },

				{ "Testcases/rules/SA00047/EmptyMessage-Invoke-FromParts.bpel",
						"47, 53" },
				{
						"Testcases/rules/SA00047/EmptyMessage-Invoke-ToParts-FromParts.bpel",
						"47, 54, 53" },
				{ "Testcases/rules/SA00047/EmptyMessage-Invoke-ToParts.bpel",
						"47, 54" },
				{
						"Testcases/rules/SA00047/EmptyMessage-OnEvent-FromParts.bpel",
						"47, 53" },
				{
						"Testcases/rules/SA00047/EmptyMessage-OnMessage-FromParts.bpel",
						"47, 53" },
				{
						"Testcases/rules/SA00047/EmptyMessage-Receive-FromParts.bpel",
						"47, 53" },
				{ "Testcases/rules/SA00047/EmptyMessage-Reply-ToParts.bpel",
						"47, 54" },
				{
						"Testcases/rules/SA00047/Invoke-OneWay-NoInputVariable-NoToParts.bpel",
						"47" },
				{
						"Testcases/rules/SA00047/Invoke-RequestResponse-NoInputOutputVariables-NoToFromParts.bpel",
						"47" },
				{
						"Testcases/rules/SA00047/Invoke-RequestResponse-NoInputVariable-NoToParts.bpel",
						"47" },
				{
						"Testcases/rules/SA00047/Invoke-RequestResponse-NoOutputVariable-NoFromParts.bpel",
						"47" },
				{ "Testcases/rules/SA00047/NoVariable-NoFromPart-OnEvent.bpel",
						"47" },
				{
						"Testcases/rules/SA00047/NoVariable-NoFromPart-OnMessage.bpel",
						"47" },
				{ "Testcases/rules/SA00047/NoVariable-NoFromPart-Receive.bpel",
						"47" },
				{
						"Testcases/rules/SA00047/NoVariable-NoToPart-NoFromPart-ReceiveReply.bpel",
						"47" },
				{ "Testcases/rules/SA00047/NoVariable-NoToPart-Reply.bpel",
						"47" },

				{
						"Testcases/rules/SA00048/InputOutputVariable-Message-NotFound.bpel",
						"48" },
				{
						"Testcases/rules/SA00048/InputVariable-MessageType-Message-NotFound.bpel",
						"48" },
				{
						"Testcases/rules/SA00048/InputVariable-Type-MessageManyParts.bpel",
						"48" },
				{
						"Testcases/rules/SA00048/InputVariable-Type-MessageOnePart-NotFound.bpel",
						"48" },
				{
						"Testcases/rules/SA00048/OutputVariable-MessageType-Message-NotFound.bpel",
						"48" },
				{
						"Testcases/rules/SA00048/OutputVariable-Type-MessageManyParts.bpel",
						"48" },
				{
						"Testcases/rules/SA00048/OutputVariable-Type-MessageOnePart-NotFound.bpel",
						"48" },
				...
				{
						"Testcases/rules/SA00051/Invoke-ToPartsAndInputVariable.bpel",
						"51" },

				{
						"Testcases/rules/SA00052/Invoke-FromPartsAndOutputVariable.bpel",
						"52" },

				{
						"Testcases/rules/SA00053/Invoke-FromPartDifferingFromMessageDefinition.bpel",
						"53" },
				{
						"Testcases/rules/SA00053/OnEvent-FromPartDifferingFromMessageDefinition.bpel",
						"53" },
				{
						"Testcases/rules/SA00053/OnMessage-FromPartDifferingFromMessageDefinition.bpel",
						"53" },
				{
						"Testcases/rules/SA00053/Receive-FromPartDifferingFromMessageDefinition.bpel",
						"53" },

				{
						"Testcases/rules/SA00054/Invoke-ToPartDifferingFromMessageDefinition.bpel",
						"54" },
				{
						"Testcases/rules/SA00054/Reply-ToPartDifferingFromMessageDefinition.bpel",
						"54" },

				{
						"Testcases/rules/SA00055/Receive-WithFromPartElementAndVariableAttribute.bpel",
						"55" },

				{
						"Testcases/rules/SA00059/Reply-WithToPartElementAndVariableAttribute.bpel",
						"59" },

				{
						"Testcases/rules/SA00062/Pick-CreateInstanceWithOnAlarm.bpel",
						"62" },

				{
						"Testcases/rules/SA00063/OnMessage-With-FromPartAndAttributeVariable.bpel",
						"63" },

				{
						"Testcases/rules/SA00076/ForEach-DuplicateCounterVariable.bpel",
						"76" },

				{ "Testcases/rules/SA00080/EmptyFaultHandlersInProcess.bpel",
						"80" },
				{ "Testcases/rules/SA00080/EmptyFaultHandlersInProcess.bpel",
						"80" },

				{ "Testcases/rules/SA00083/EmptyEventHandlersInProcess.bpel",
						"83" },
				{ "Testcases/rules/SA00083/EmptyEventHandlersInProcess.bpel",
						"83" },
