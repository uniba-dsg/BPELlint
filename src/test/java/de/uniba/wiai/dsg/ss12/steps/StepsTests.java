...
public class StepsTests {
	...
	@Test
	public void testAddingDefaults() throws IOException, TransformerException, SAXException, ParserConfigurationException, InvalidCanonicalizerException, CanonicalizationException {
	...
	@Test
	public void testApplyingInheritanceRules() throws IOException, TransformerException, SAXException, ParserConfigurationException, ParsingException, InvalidCanonicalizerException, CanonicalizationException {
	...
	@Test
	public void testApplyingInheritanceRulesWithPredefined() throws IOException, TransformerException, SAXException, ParserConfigurationException, ParsingException, InvalidCanonicalizerException, CanonicalizationException {
	...
	private void assertXMLEquals(String expected, String actual) throws InvalidCanonicalizerException, ParserConfigurationException, SAXException, CanonicalizationException, IOException {
		Init.init();

		Canonicalizer canon = Canonicalizer.getInstance(Canonicalizer.ALGO_ID_C14N_OMIT_COMMENTS);
		String expectedCanonicalized = new String(canon.canonicalize(expected.getBytes()));
		String actualCanonicalized = new String(canon.canonicalize(actual.getBytes()));
